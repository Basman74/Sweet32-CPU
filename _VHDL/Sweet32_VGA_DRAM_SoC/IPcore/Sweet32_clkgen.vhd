...
-- Module  Version: 5.6
--C:\lscc\diamond\3.3_x64\ispfpga\bin\nt64\scuba.exe -w -n Sweet32_clkgen -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 50 -fclkop 100 -fclkop_tol 0.0 -fclkos 100 -fclkos_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -fb_mode 1 
...
entity Sweet32_clkgen is
    port (
        CLKI: in  std_logic; 
        CLKOP: out  std_logic; 
        CLKOS: out  std_logic);
 attribute dont_touch : boolean;
 attribute dont_touch of Sweet32_clkgen : entity is true;
end Sweet32_clkgen;

architecture Structure of Sweet32_clkgen is
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  4, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  4, 
        ...
        CLKOS_DIV=>  5, CLKOP_DIV=>  5, CLKFB_DIV=>  2, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of Sweet32_clkgen is
    for Structure
