...
-- Module  Version: 5.6
--C:\lscc\diamond\3.3_x64\ispfpga\bin\nt64\scuba.exe -w -n Sweet32_vgaclkgen -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 50 -fclkop 25 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 
...
entity Sweet32_vgaclkgen is
    port (
        CLKI: in  std_logic; 
        CLKOP: out  std_logic);
 attribute dont_touch : boolean;
 attribute dont_touch of Sweet32_vgaclkgen : entity is true;
end Sweet32_vgaclkgen;

architecture Structure of Sweet32_vgaclkgen is
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  20, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  21, CLKFB_DIV=>  1, CLKI_DIV=>  2, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of Sweet32_vgaclkgen is
    for Structure
